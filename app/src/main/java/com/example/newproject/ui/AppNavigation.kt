    ...
    AppTheme(colors = currentColors, assets = currentAssets) {
        NavHost(navController = navController, startDestination = Routes.WELCOME) {
            ...
            composable(
                ...
                val viewModel =
                    hiltViewModel<com.example.newproject.ui.profile.security.SecurityCenterViewModel>()
            ...
            composable(
                ...
                val viewModel =
                    hiltViewModel<com.example.newproject.ui.profile.transaction.TransactionHistoryViewModel>()
            ...
            composable(
                ...
                val viewModel =
                    hiltViewModel<com.example.newproject.ui.profile.verification.VerificationStatusViewModel>()
            ...
            composable(
                ...
                val viewModel =
                    hiltViewModel<com.example.newproject.ui.home.setting.SettingViewModel>()
                SettingScreen(
                    viewModel = viewModel,
                    onBack = { navController.popBackStack() },
                    onNavigate = { navController.navigate(it) }
