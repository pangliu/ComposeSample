...
val themeDarkGray = Color.DarkGray
...
val neonDarkPurple = Color(0xFF4E3E83)
val neonPurpleLight = Color(0xFFC984D0)
val neonDarkBlue = Color(0xFF6668DB)
val neonMellowPeach = Color(0xFFFDACA2)
...
val salmonRed = Color(0xFFFF7474)          // DeleteAccountDialog 警示 icon / 標題 / Delete 按鈕文字（Neon）
val darkGarnet = Color(0xFF5C1010)         // DeleteAccountDialog Delete 按鈕底色（Neon）
val pinkOrchid = Color(0xFFF6A5F9)         // DeleteAccountDialog Cancel 按鈕邊框 / 文字（Neon）
...
val pearlGray = Color(0xFFC9C9C9)          // DeleteAccountDialog Cancel 按鈕邊框（Black Gold）
...
val paleChampagne = Color(0xFFFFE29C)     // XEssentialsCard EssentialItemView 邊框漸層中段 / icon 顏色
val coolGray = Color(0xFFCACACA)          // XEssentialsCard 標籤文字 / Edit 按鈕文字
val richBlack = Color(0xFF0A0A0A)         // XEssentialsCard EssentialItemView 圖示方塊背景
val mutedGold = Color(0xFFC6B896)         // QuestCard 連結文字（Claim your loot here / Start your grid & earn）
val espressoBrown = Color(0xFF312320)     // MyQrActionButton icon / 文字（Black Gold）
val caramelGold = Color(0xFFA78162)       // QrModeTabSelector 外框 / 選中 Tab 漸層兩端（Black Gold）
val apricotGold = Color(0xFFF1D3AF)       // QrModeTabSelector 外框 / 選中 Tab 漸層中段（Black Gold）
val camelGold = Color(0xFFBF9471)         // InputAmountScreen Review Details 按鈕漸層兩端（Black Gold）
val bronzeGold = Color(0xFFAA7C2D)        // ProfileScreen Invite Friends 按鈕漸層兩端（Black Gold）
val tawnyGold = Color(0xFFAC894E)         // InviteFriendsDialog 標題 / 分享 icon 漸層兩端（Black Gold）
val walnutGold = Color(0xFF916A49)        // ConfirmPaymentScreen Cancel / Confirm & Pay 按鈕漸層兩端（Black Gold）
val deepMaroon = Color(0xFF6E181A)        // UnlinkCardDialog Unlink 按鈕漸層兩端（Black Gold）
val dustyRose = Color(0xFFA75657)         // UnlinkCardDialog Unlink 按鈕漸層次段（Black Gold）
val blushPink = Color(0xFFFF999A)         // UnlinkCardDialog Unlink 按鈕漸層中心 / 邊框（Black Gold）
val coralRed = Color(0xFFFF676B)          // UnlinkCardDialog 警示 icon / 標題文字（Black Gold）
val rosewoodPink = Color(0xFFC7718A)      // VerificationStatusScreen PENDING 進度條外框漸層左端（Black Gold）
val wineRed = Color(0xFF873537)           // VerificationStatusScreen ACTION REQUIRED 按鈕邊框（Black Gold）
val midnightIndigo = Color(0xFF1B1C31)    // TransactionSuccessfulScreen Done 按鈕漸層兩端（Black Gold）
val slateViolet = Color(0xFF565A97)       // TransactionSuccessfulScreen Done 按鈕漸層中段（Black Gold）
val deepViolet = Color(0xFF1B0D30)        // TransactionSuccessfulScreen Share 按鈕漸層兩端（Black Gold）
val amethystPurple = Color(0xFF603F92)    // TransactionSuccessfulScreen Share 按鈕漸層中段（Black Gold）
val darkObsidian = Color(0xFF070B12)