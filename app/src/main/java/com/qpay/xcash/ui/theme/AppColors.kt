...
data class AppColors(
    ...
    val friendTopBar: FriendTopBarColors,
    val friendList: FriendListColors,
    val friendDetail: FriendDetailColors,
...
val NeonColors = AppColors(
    ...
    friendTopBar = NeonFriendTopBarColors,
    friendList = NeonFriendListColors,
    friendDetail = NeonFriendDetailColors,
...
val BlackGoldColors = AppColors(
    ...
    friendTopBar = BlackGoldFriendTopBarColors,
    friendList = BlackGoldFriendListColors,
    friendDetail = BlackGoldFriendDetailColors,
